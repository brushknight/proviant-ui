		...
		<KeyboardAvoidingView
			...
			<ScrollView contentContainerStyle={styles.scroll_view}>
				...
				<View style={styles.form}>
					...
					>
						<Text style={styles.button_text}>{registerStatus === STATUS_SENDING ? 'Отправка...' : 'Регистрация'}</Text>
					</TouchableOpacity>
					<TouchableOpacity
						style={[styles.button, styles.button_register]}
						onPress={loginHandler}
					>
						<Text style={styles.button_text}>{loginStatus === STATUS_SENDING ? 'Отправка...' : 'Вход'}</Text>
					</TouchableOpacity>
					{/*{passwordRemoveButton}*/}
