...
export const fetchEditList = (id, locale) => {
	return (dispatch) => {
		...
		axios.get(generateCoreApiUrl(`/list/${id}/`), generateLocaleHeader(locale))
			.then(response => {
...
export const updateList = (id, title, locale) => {
	return (dispatch) => {
		...
		axios.put(generateCoreApiUrl(`/list/${id}/`), json, generateLocaleHeader(locale))
			.then(response => {
				const data = response.data
...
export const deleteList = (id, locale) => {
	return (dispatch) => {
		axios.delete(generateCoreApiUrl(`/list/${id}/`), generateLocaleHeader(locale))
			.then(response => {
				const data = response.data
