...
export const ACTION_CHANGE_STOCK_ADD_FORM_FIELD = 'change/stock/add_form_field'
export const ACTION_CHANGE_STOCK_CONSUME_FORM_FIELD = 'change/stock/consume_form_field'
